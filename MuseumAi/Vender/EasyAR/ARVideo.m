...
- (void)openVideoFile:(NSString *)path texid:(int)texid
{
    ...
    [player open:path_ storageType:easyar_StorageType_Absolute callback:^(easyar_VideoStatus status) {
...
//            [player pause];
            [self onLost];
            [[NSNotificationCenter defaultCenter] postNotificationName:kARPlayCompleteNotification object:self];
        }
    }
}
